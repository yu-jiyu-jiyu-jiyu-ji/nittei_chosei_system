...
def _normalize_worker_ranks(value: Any) -> List[str]:
    """worker_ranks を常に文字列リストへ正規化する."""
...
def get_settings() -> Dict[str, Any]:
    ...
    try:
        ...
        result.update(data)
        result["worker_ranks"] = _normalize_worker_ranks(result.get("worker_ranks"))
        return result
